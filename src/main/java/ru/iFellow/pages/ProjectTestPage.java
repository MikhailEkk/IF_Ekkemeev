...
public class ProjectTestPage {
    ...
    public void createNewTaskSimpleOption(String taskTopic) {
    ...
    public void createNewTaskAllFieldsFill(String taskTopic) {
        createTaskBtn.shouldBe(visible).click();
        inputFieldSubject.shouldBe(visible).setValue(taskTopic);
    ...
    public void completeTask() {
        ...
        fulfilledBtn.should(appear, Duration.ofSeconds(15)).shouldBe(interactable).click();
        fulfilledBtnInForm.shouldBe(visible, Duration.ofSeconds(15)).click();
        completedBtn.should(exist, Duration.ofSeconds(15));
        bisinessProcess.shouldBe(visible, Duration.ofSeconds(15)).click();
        completedBtn.should(appear, Duration.ofSeconds(15)).shouldBe(interactable).click();
    }
